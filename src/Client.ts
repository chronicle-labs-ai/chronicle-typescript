...
import { BacktestsClient } from "./api/resources/backtests/client/Client.js";
...
export class ChronicleLabsApiClient {
    ...
    protected _backtests: BacktestsClient | undefined;
    ...
    public get backtests(): BacktestsClient {
        return (this._backtests ??= new BacktestsClient(this._options));
    }
