 ...
 *     }
 */
export interface RegisterAgentArtifactRequest {
    artifact: RegisterAgentArtifactRequest.Artifact;
    ...
    metadata?: RegisterAgentArtifactRequest.Metadata | null;
    /** Defaults to `current`. Registering a new current version atomically demotes the previous current version to stable. */
    status?: RegisterAgentArtifactRequest.Status | null;
}

export namespace RegisterAgentArtifactRequest {
