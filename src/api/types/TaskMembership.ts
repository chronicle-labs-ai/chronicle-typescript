...
export interface TaskMembership {
    ...
    purpose?: (TaskMembership.Purpose | null) | undefined;
    refreshAvailable: boolean;
    revision: number;
    /** Train / validation / test split assignment. */
    split?: (TaskMembership.Split | null) | undefined;
    subjectId: string;
