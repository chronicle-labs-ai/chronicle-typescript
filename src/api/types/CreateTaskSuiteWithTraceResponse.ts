...
export interface CreateTaskSuiteWithTraceResponse {
    dataset: CreateTaskSuiteWithTraceResponse.Dataset;
    /** The compact membership projection returned to Dataset and Timeline clients. */
    membership: CreateTaskSuiteWithTraceResponse.Membership;
}

export namespace CreateTaskSuiteWithTraceResponse {
