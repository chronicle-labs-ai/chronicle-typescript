...
export interface BacktestsAvailability {
    agents: BacktestsAvailability.Agents.Item[];
    datasetSnapshots: Record<string, BacktestsAvailability.DatasetSnapshots.Value>;
    datasets: BacktestsAvailability.Datasets.Item[];
    /** Environment row identities + status. Detailed snapshot lives behind `GET /api/platform/environments/:id`. */
    environments: BacktestsAvailability.Environments.Item[];
}

export namespace BacktestsAvailability {
    ...
    export namespace DatasetSnapshots {
        export interface Value {
            clusters: Value.Clusters.Item[];
            dataset: Value.Dataset;
            edges: Value.Edges.Item[];
            /** Optional pre-built event index used by the Timeline tab. */
            events?: (Value.Events.Item[] | null) | undefined;
            /** Task definitions, one per trace. Absent on snapshots built by clients that only render the timeline. */
            tasks?: (Value.Tasks.Item[] | null) | undefined;
            traces: Value.Traces.Item[];
        }
    ...
    export type Datasets = Datasets.Item[];
